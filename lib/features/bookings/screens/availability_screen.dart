...
class _AvailabilityScreenState extends ConsumerState<AvailabilityScreen> {
  ...
  Future<void> _handleConfirmBooking(List<TimeSlot> requestedSlots) async {
    ...
    try {
      ...
      if (mounted) {
        context.pop(); // Directly return to resource home page
      }
    } catch (e) {
      if (mounted) {
        setState(() {
          ...
          return SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                // 5. Booking Summary Card & Submit CTA
                if (_selectedStartTimeSlot != null && requestedSlots.isNotEmpty) ...[
                  Card(
                    child: Padding(
