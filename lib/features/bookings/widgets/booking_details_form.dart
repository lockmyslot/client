...
class _BookingDetailsFormState extends ConsumerState<BookingDetailsForm> {
  ...
  List<TimeSlot> _calculateRequestedSlots(List<TimeSlot> allSlots) {
    ...
    final startIndex = allSlots.indexWhere(
      (s) => s.startTime.isAtSameMomentAs(_selectedStartTimeSlot!.startTime),
    );
  ...
  Future<void> _handleConfirmBooking(List<TimeSlot> requestedSlots) async {
    ...
    try {
      ...
      ref.invalidate(
        myBookingsProvider((groupId: widget.groupId, status: null)),
      );
      ref.invalidate(
      ...
      if (mounted) {
        context
            .pop(); // Directly return to the screen the booking was launched from
      }
    } catch (e) {
      if (mounted) {
        setState(() {
  ...
  Widget _buildBottomBar({
    ...
    required List<TimeSlot> requestedSlots,
  }) {
    return Container(
        ...
        children: [
          Row(
            children: [
              ...
              const SizedBox(width: 8),
              PrimaryBadge(child: Text(isValid ? 'Available' : 'Unavailable')),
            ],
          ),
          if (!isValid) ...[
    ...
    return SlideFadeSwitcher(
      child: availabilityAsync.when(
        ...
        data: (availability) {
          ...
          final showSummary =
              _selectedStartTimeSlot != null && requestedSlots.isNotEmpty;
                    ...
                    child: Column(
                      ...
                      children: [
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SlideFadeSwitcher(
                                        ...
                                        child: Text(
                                          '${userStats.bookingsToday}${userStats.maxBookingsPerDay != null ? '/${userStats.maxBookingsPerDay}' : ''}',
                                          key: ValueKey(
                                            '${userStats.bookingsToday}/${userStats.maxBookingsPerDay}',
                                          ),
                                        ).h4(),
                                      ),
                                    ],
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      SlideFadeSwitcher(
                                        ...
                                        child: Text(
                                          '${userStats.hoursToday.toStringAsFixed(1)}${userStats.maxHoursPerDay != null ? '/${userStats.maxHoursPerDay}' : ''}h',
                                          key: ValueKey(
                                            '${userStats.hoursToday.toStringAsFixed(1)}/${userStats.maxHoursPerDay}h',
                                          ),
                                        ).h4(),
                                      ),
                                    ],
                        ...
                        if (availability.availableFrom != null ||
                          ...
                          Text(
                            'Available hours: ${AppDateUtils.formatTimeString(availability.availableFrom ?? '00:00')} - ${AppDateUtils.formatTimeString(availability.availableUntil ?? '24:00')}',
                          ).small().muted(),
                        ],
                        ...
                        if (allSlots.isEmpty)
                          const Padding(
                            ...
                            child: Center(
                              child: Text(
                                'No bookable slots available for this date.',
                              ),
                            ),
                          )
                        else
                          ...
                          GridView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              final isSelected =
                                  _selectedStartTimeSlot?.startTime
                                    ...
                                    child: Row(
                                      children: List.generate(4, (index) {
                                        ...
                                        final durationMinutes =
                                            durationUnits * slotMinutes;
                                        final isSelected =
                                            _selectedDurationSlots ==
                                            durationUnits;
                                        ...
                                        if (durationMinutes < 60) {
                                          ...
                                          durationLabel =
                                              '${(durationMinutes / 60).toStringAsFixed(1)} hours';
                                        }
