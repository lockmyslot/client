class BookingRule {
  ...
  factory BookingRule.fromJson(Map<String, dynamic> json) {
    return BookingRule(
      ...
      dayScope:
          json['day_scope'] as String? ??
          json['dayScope'] as String? ??
          'WEEKDAY',
      maxBookingsPerDay:
      ...
      minDurationMinutes:
          json['min_duration_minutes'] as int? ??
          json['minDurationMinutes'] as int?,
      maxDurationMinutes:
          json['max_duration_minutes'] as int? ??
          json['maxDurationMinutes'] as int?,
      maxAdvanceBookingDays:
          json['max_advance_booking_days'] as int? ??
          json['maxAdvanceBookingDays'] as int?,
      availableFrom:
