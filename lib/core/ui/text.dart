...
extension LockMySlotText on Widget {
  ...
  /// Heading 4.
  Widget h4() => _styled(
    style: (tt, _) => tt.titleLarge?.copyWith(fontWeight: FontWeight.w600),
  );
  ...
  Widget lead() => _styled(
    style: (tt, cs) =>
        tt.bodyLarge?.copyWith(height: 1.4, color: cs.onSurfaceVariant),
  );

  /// Small text.
  Widget small() => _styled(style: (tt, _) => tt.bodySmall);

  /// Small text (alias of [small]).
  Widget textSmall() => _styled(style: (tt, _) => tt.bodySmall);
  ...
  Widget muted() =>
      _styled(style: (_, cs) => TextStyle(color: cs.onSurfaceVariant));
  ...
  /// Semi-bold weight.
  Widget semiBold() =>
      _styled(style: (_, __) => const TextStyle(fontWeight: FontWeight.w600));

  /// Bold weight.
  Widget bold() =>
      _styled(style: (_, __) => const TextStyle(fontWeight: FontWeight.bold));

  /// Italic style.
  Widget italic() =>
      _styled(style: (_, __) => const TextStyle(fontStyle: FontStyle.italic));
}
